...
echo "<以下lesson2の表示><br />";

$hanako = new Patient("花子", 23, "女", 1.6, 50.5);

echo $hanako->name . "さんの身長は" . $hanako->getHeight() . "mなので平均体重は" . $hanako->calculateStandardWeight() . "kgです。現在の体重は" . $hanako->getWeight() . "kgです。";